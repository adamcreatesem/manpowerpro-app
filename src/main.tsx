...
const Candidates = lazy(() => import("./pages/Candidates.tsx"));
...
const TravelDesk = lazy(() => import("./pages/TravelDesk.tsx"));
const Aftercare = lazy(() => import("./pages/Aftercare.tsx"));
          ...
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              ...
              >
                ...
                <Route path="travel" element={<TravelDesk />} />
